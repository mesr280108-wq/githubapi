...
Para o desenvolvimento do protótipo, a equipe deverá atender aos seguintes requisitos estabelecidos no projeto:

* **Vão livre:** 80 cm entre as duas mesas;
* **Comprimento total:** máximo de 1 m;
...
Durante o desenvolvimento do protótipo, a equipe deverá respeitar as seguintes restrições:

* Não utilizar **apoios intermediários**;
* Não utilizar **barras, perfis ou cabos metálicos**;
* Não utilizar **concreto ou argamassa**;
* Não utilizar **componentes estruturais prontos**;
* Não utilizar **peças produzidas por impressão 3D**;
* Não utilizar **fibra de carbono**;
* Não utilizar **fibra de vidro industrial**;
* Não utilizar **chapas estruturais comerciais de alta resistência**;
* Não utilizar **parafusos, pregos, grampos ou rebites** como elementos de união;
